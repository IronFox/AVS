...
public abstract partial class AvsVehicle : Vehicle, ICraftTarget, IProtoTreeEventListener
{
    ...
    public VehicleComposition Com => _composition
                                     ?? throw new InvalidOperationException(
                                         $"This vehicle's composition has not yet been initialized. Please wait until {nameof(AvsVehicle)}.Awake() has been called");
    ...
    public MiniWorld SpawnMiniWorld(Transform worldObject, Material material, int mapWorldRadius = 200,
    ...
    private void RequireComposition()
    {
        if (_composition is null)
        {
            ...
            if (_composition is null)
                throw new InvalidOperationException(
                    "Vehicle composition cannot be null. Please ensure Get*Composition() is implemented correctly.");
        }
    }
    ...
    public override void Update()
    {
        ...
        if (crushDamageEmitter.IsNotNull())
        {
            if (IsBoarded)
        ...
        var hadNoPlayerPosition = playerPosition.IsNull();
    ...
    /// </summary>
    public override string vehicleDefaultName => Translator.Get(TranslationKey.VehicleDefaultName);
    ...
    {
        var isBeneathSurface = !worldForces.IsAboveWater();
    ...
    public PingInstance HudPingInstance => hudPingInstance.OrThrow(() => new InvalidOperationException(
    ...
    [SerializeField] internal EnergyInterface? aiEnergyInterface;
    ...
    /// </remarks>
    [SerializeField] internal FMOD_StudioEventEmitter? ambienceSound;
    ...
    /// </summary>
    public PowerManager PowerManager => powerManager.OrThrow(() => new InvalidOperationException(
    ...
    //                continue;
    //            }
    //            if (Com.CanopyWindows.IsNotNull() && Com.CanopyWindows.Contains(renderer.gameObject))
    //            {
    //                continue;
    //            }
    ...
    public void GetHUDValues(out float health, out float power)
    {
        ...
        GetEnergyValues(out var num, out var num2);
