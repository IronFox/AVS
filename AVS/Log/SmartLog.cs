...
namespace AVS.Log
{
    ...
    public class SmartLog : IDisposable, INullTestableType
    {
        ...
        /// <summary>
        /// Logs a debug message generated by the provided message factory function if the current log verbosity level is set to <see cref="Verbosity.Verbose"/>.
        /// </summary>
        /// <remarks>The method will not invoke the message factory or log the message if the log verbosity level is not set to <see cref="Verbosity.Verbose"/>.</remarks>
        /// <param name="messageFactory">
        /// The function that generates the debug message to log. This function is only invoked if the log verbosity level is set to <see cref="Verbosity.Verbose"/>.
        /// </param>
        public void Debug(Func<string> messageFactory)
        {
            ...
            {
                SignalLog();
                Logger.Log(MakeMessage(messageFactory(), extraTag: "DBG"));
            }
            catch (Exception ex)
            {
