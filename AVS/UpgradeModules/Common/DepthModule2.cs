...
namespace AVS.UpgradeModules.Common
{
    ...
    {
        public DepthModule2(MainPatcher mp) : base(mp)
        {
        }

        /// <inheritdoc/>
        public override string ClassId => MainPatcher.ModName + "DepthModule2";
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public override Sprite Icon => MainPatcher.DepthModule2Icon;
        /// <inheritdoc/>
