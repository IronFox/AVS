...
namespace AVS.UpgradeModules.Common
{
    ...
    {
        public DepthModule2(RootModController rmc) : base(rmc)
        {
        }

        /// <inheritdoc/>
        public override string ClassId => Owner.ModName + "DepthModule2";
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public override Sprite Icon => Owner.DepthModule2Icon;
        /// <inheritdoc/>
