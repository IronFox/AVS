...
internal static class VanillaUpgradeMaker
{
    ...
    internal static Nautilus.Assets.CustomPrefab CreateModuleVanilla(AvsVehicleModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info)
    {
        ...
        {
            var scanGadget = prefab.SetUnlock(upgrade.UnlockTechType);
            if (upgrade.UnlockedSprite.IsNotNull())
                scanGadget.WithAnalysisTech(upgrade.UnlockedSprite, unlockMessage: upgrade.UnlockedMessage);
        }

        return prefab;
    }

    private static Nautilus.Assets.CustomPrefab AddRecipe(this Nautilus.Assets.CustomPrefab customPrefab,
        AvsVehicleModule upgrade, VehicleType vType)
    {
        var moduleRecipe = upgrade.GetRecipe(vType).ToRecipeData();
    ...
    internal static void CreatePassiveModule(AvsVehicleModule upgrade, UpgradeCompat compat, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
        if (upgrade.IsVehicleSpecific)
            return;
        var isPdaRegistered = isPdaSetup;
    ...
    internal static void CreateSelectModule(SelectableModule select, UpgradeCompat compat, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
    ...
    internal static void CreateChargeModule(SelectableChargeableModule selectcharge, UpgradeCompat compat,
        ref UpgradeTechTypes utt, bool isPdaSetup)
    {
    ...
    internal static void CreateChargeModule(ChargeableModule charge, UpgradeCompat compat, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
    ...
    internal static void CreateToggleModule(ToggleableModule toggle, UpgradeCompat compat, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
    ...
    internal static void AddPassiveActions(UpgradeModuleGadget gadget, AvsVehicleModule upgrade,
        Nautilus.Assets.PrefabInfo info)
    {
        gadget
    ...
    internal static void AddSelectActions(UpgradeModuleGadget gadget, SelectableModule upgrade,
        Nautilus.Assets.PrefabInfo info)
    {
        gadget
    ...
    internal static void AddToggleActions(UpgradeModuleGadget gadget, ToggleableModule upgrade,
        Nautilus.Assets.PrefabInfo info)
    {
        gadget
    ...
    internal static void AddChargeActions(UpgradeModuleGadget gadget, SelectableChargeableModule upgrade,
        Nautilus.Assets.PrefabInfo info)
    {
        gadget
    ...
    internal static void AddChargeActions(UpgradeModuleGadget gadget, ChargeableModule upgrade,
        Nautilus.Assets.PrefabInfo info)
    {
        gadget
            .WithMaxCharge(upgrade.ChargeLimit) // this creates a harmless Nautilus warning
    ...
    internal static TechType CreatePassiveModuleVanilla(AvsVehicleModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info, EquipmentType equipType, VehicleType vType)
    {
        var prefab = CreateModuleVanilla(upgrade, isPdaSetup, info)
            .AddRecipe(upgrade, vType);
        var gadget = prefab.SetVehicleUpgradeModule(equipType, QuickSlotType.Passive);
    ...
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Seamoth",
                "Seamoth " + upgrade.DisplayName, "An upgrade for the Seamoth. " + upgrade.Description,
                unlockAtStart: upgrade.UnlockAtStart)
    ...
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Exosuit",
                "Exosuit " + upgrade.DisplayName, "An upgrade for the Exosuit. " + upgrade.Description,
                unlockAtStart: upgrade.UnlockAtStart)
            .WithIcon(upgrade.Icon);
    ...
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Cyclops",
                "Cyclops " + upgrade.DisplayName, "An upgrade for the Cyclops. " + upgrade.Description,
                unlockAtStart: upgrade.UnlockAtStart)
            .WithIcon(upgrade.Icon);
        utt = utt.ReplaceCyclops(prefabInfo.TechType);
        var prefab = new Nautilus.Assets.CustomPrefab(prefabInfo);
        ...
        if (!upgrade.UnlockAtStart)
        {
            var scanGadge = prefab.SetUnlock(upgrade.UnlockTechType);
            if (upgrade.UnlockedSprite.IsNotNull())
    ...
    internal static TechType CreateSelectModuleVanilla(SelectableModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info, EquipmentType equipType, VehicleType vType)
    {
        var prefab = CreateModuleVanilla(upgrade, isPdaSetup, info)
            .AddRecipe(upgrade, vType);
        var gadget = prefab.SetVehicleUpgradeModule(equipType, QuickSlotType.Selectable);
        AddPassiveActions(gadget, upgrade, info);
    ...
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Cyclops",
                "Cyclops " + upgrade.DisplayName, "An upgrade for the Exosuit. " + upgrade.Description)
            .WithIcon(upgrade.Icon);
        utt = utt.ReplaceCyclops(prefabInfo.TechType);
    ...
    internal static TechType CreateChargeModuleVanilla(SelectableChargeableModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info, EquipmentType equipType, VehicleType vType)
    {
        var prefab = CreateModuleVanilla(upgrade, isPdaSetup, info)
            .AddRecipe(upgrade, vType);
        var gadget = prefab.SetVehicleUpgradeModule(equipType, QuickSlotType.SelectableChargeable);
        AddPassiveActions(gadget, upgrade, info);
    ...
    internal static void CreateChargeModuleSeamoth(SelectableChargeableModule upgrade, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Seamoth",
                "Seamoth " + upgrade.DisplayName, "An upgrade for the Seamoth. " + upgrade.Description,
    ...
    internal static void CreateChargeModuleExosuit(SelectableChargeableModule upgrade, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Exosuit",
                "Exosuit " + upgrade.DisplayName, "An upgrade for the Exosuit. " + upgrade.Description,
    ...
    internal static void CreateChargeModuleCyclops(SelectableChargeableModule upgrade, ref UpgradeTechTypes utt,
        bool isPdaSetup)
    {
        var prefabInfo = Nautilus.Assets.PrefabInfo.WithTechType(upgrade.ClassId + "Cyclops",
                "Cyclops " + upgrade.DisplayName, "An upgrade for the Exosuit. " + upgrade.Description)
    ...
    internal static TechType CreateChargeModuleVanilla(ChargeableModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info, EquipmentType equipType, VehicleType vType)
    {
        var prefab = CreateModuleVanilla(upgrade, isPdaSetup, info)
            .AddRecipe(upgrade, vType);
    ...
    internal static TechType CreateToggleModuleVanilla(ToggleableModule upgrade, bool isPdaSetup,
        Nautilus.Assets.PrefabInfo info, EquipmentType equipType, VehicleType vType)
    {
        var prefab = CreateModuleVanilla(upgrade, isPdaSetup, info)
            .AddRecipe(upgrade, vType);
        var gadget = prefab.SetVehicleUpgradeModule(equipType, QuickSlotType.Toggleable);
        AddPassiveActions(gadget, upgrade, info);
