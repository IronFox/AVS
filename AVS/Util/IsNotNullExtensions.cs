...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static bool IsNotNull<T0>([NotNullWhen(true)] this Func<T0>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1>([NotNullWhen(true)] this Func<T0, T1>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2>([NotNullWhen(true)] this Func<T0, T1, T2>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3>([NotNullWhen(true)] this Func<T0, T1, T2, T3>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5, T6>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5, T6>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5, T6, T7>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5, T6, T7>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5, T6, T7, T8>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? acc)
        => acc is not null;

    public static bool IsNotNull<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>([NotNullWhen(true)] this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>? acc)
        => acc is not null;
}