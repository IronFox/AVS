...
namespace AVS.SaveLoad
{
    ...
    public class DataBlock : IEnumerable<IPersistable>
    {
        ...
        public IEnumerator<IPersistable> GetEnumerator()
        {
            return ((IEnumerable<IPersistable>)Properties).GetEnumerator();
        }
        /// <summary>
        ...
        private List<IPersistable> properties = new List<IPersistable>();
    ...
    public static class Persistable
    {
        ...
        public static PersistentProperty<T> Property<T>(string name, Func<T> get, Action<T> set)
        {
            return new PersistentProperty<T>(name, get, set);
        }
    }
