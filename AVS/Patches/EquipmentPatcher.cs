...
public class EquipmentPatcher
{
    ...
    public static void GetCompatibleSlotDefaultPrefix(Equipment __instance, EquipmentType itemType,
        ref Dictionary<EquipmentType, List<string>> ___typeToSlots)
    {
    ...
    public static void GetFreeSlotPrefix(Equipment __instance, EquipmentType type,
        ref Dictionary<EquipmentType, List<string>> ___typeToSlots)
    {
    ...
    public static void GetSlotsPrefix(Equipment __instance, EquipmentType itemType,
        ref Dictionary<EquipmentType, List<string>> ___typeToSlots)
    {
        if (!AvsVehicleBuilder.IsKnownItemType(itemType))
            return;
