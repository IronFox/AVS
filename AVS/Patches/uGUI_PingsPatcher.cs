...
namespace AVS.Patches
{
    ...
    class uGUI_PingsPatcher
    {
        ...
        static IEnumerable<CodeInstruction> uGUI_PingsOnAddTranspiler(IEnumerable<CodeInstruction> input)
        {
            ...
            var index = instList.FindIndexOf(i => i.opcode == OpCodes.Callvirt && i.operand.ToString().Contains("Void SetIcon(Sprite)"));
            if (index < 0)
