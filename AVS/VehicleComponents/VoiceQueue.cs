...
public class VoiceLine : INullTestableType
{
    ...
    /// </summary>
    public bool HasAnyClips => Clip.IsNotNull() || (Clips.IsNotNull() && Clips.Count > 0);
    ...
    public VoiceLine(IReadOnlyList<AudioClip>? clips, IReadOnlyList<float>? gaps, string? textTranslationKey,
        int priority = 0)
    {
        Clips = clips;
        Gaps = gaps;
