...
internal class Subsystem : HandTarget, IHandTarget
{
    ...
    public override void Awake()
    {
        ...
        if (gameObject.GetComponent<LiveMixin>().IsNotNull())
        {
            ErrorMessage.AddError(
                $"The Subsystem {name} was added to a GameObject that already has a LiveMixin! Dying!");
    ...
    internal void SetupLiveMixin(float maxHealth)
    {
        ...
        liveMixin.data.invincibleInCreative = true;
